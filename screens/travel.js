  ...
  render(){
    return(
      <ScrollView>
        ...
        <TouchableOpacity style={styles.imageContainer} onPress={() => this.props.navigation.navigate('DetailedTravel')}>
          <View style={styles.imageView}>
            <Image 
            source={require("../assets/images/travelingmethods/train.jpg")}
            style={styles.image}/>
            <ImageButton 
                title="Train" 
